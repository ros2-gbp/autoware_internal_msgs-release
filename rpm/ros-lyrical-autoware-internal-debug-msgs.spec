...
%global pkg_name autoware_internal_debug_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-autoware-internal-debug-msgs
Version:        1.16.0
Release:        1%{?dist}
...
* Wed Apr 29 2026 Ryohsuke Mitsudome <ryohsuke.mitsudome@tier4.jp> - 1.12.1-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Ryohsuke Mitsudome <ryohsuke.mitsudome@tier4.jp> - 1.12.1-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Ryohsuke Mitsudome <ryohsuke.mitsudome@tier4.jp> - 1.12.1-1
- Autogenerated by Bloom
